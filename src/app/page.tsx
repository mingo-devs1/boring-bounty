...
import { Wallet, Trophy, Users, Zap, ArrowRight, CheckCircle, TrendingUp, Shield, Sparkles } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xl font-bold text-white">Boring Bounty</span>
            </div>
            <div className="flex items-center gap-4">
              ...
              {loading ? (
                ...
                <Link
                  href={user?.role === 'organization' ? '/create-bounty' : '/bounties'}
